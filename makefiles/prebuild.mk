...
$(PRESPLASH_DEST): $(PRESPLASH_SRC) | $(BUILD_DIR)/assets
	cp $(PRESPLASH_SRC) $(PRESPLASH_DEST)

$(ICON_DEST): $(ICON_SRC) | $(BUILD_DIR)/assets
	cp $(ICON_SRC) $(ICON_DEST)

$(ASSET_MATERIAL_TTF_DEST): $(ASSET_MATERIAL_TTF_SRC) | $(BUILD_DIR)/assets
	cp $(ASSET_MATERIAL_TTF_SRC) $(ASSET_MATERIAL_TTF_DEST)

$(ASSET_MONO_TTF_DEST): $(ASSET_MONO_TTF_SRC) | $(BUILD_DIR)/assets
	cp $(ASSET_MONO_TTF_SRC) $(ASSET_MONO_TTF_DEST)

$(PRIVATE_ENTRYPOINT_DEST): $(PRIVATE_ENTRYPOINT_SRC) | $(BUILD_DIR)
	cp $(PRIVATE_ENTRYPOINT_SRC) $(PRIVATE_ENTRYPOINT_DEST)

asset-image: $(PRESPLASH_DEST) $(ICON_DEST)
.PHONY : asset-image

asset-fonts: $(ASSET_MATERIAL_TTF_DEST) $(ASSET_MONO_TTF_DEST)
.PHONY : asset-fonts
