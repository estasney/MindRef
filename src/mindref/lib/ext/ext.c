  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds) {
      ...
      switch (__pyx_nargs) {
        ...
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_GetKwValue_FASTCALL(__pyx_kwds, __pyx_kwvalues, __pyx_n_s_self_height)) != 0)) {
        ...
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_GetKwValue_FASTCALL(__pyx_kwds, __pyx_kwvalues, __pyx_n_s_self_width)) != 0)) {
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7mindref_3lib_3ext_3ext_6compute_overscroll(__pyx_self, __pyx_v_overscroll, __pyx_v_target_height, __pyx_v_overscroll_threshold);
