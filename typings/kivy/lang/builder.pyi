...
def create_handler(
    iself, element, key, value, rule, idmap, delayed=...
) -> tuple[Any, Any]: ...
...
class BuilderBase:
    ...
    def load_file(
        self, filename: str, encoding: str = "utf8", **kwargs: object
    ) -> Widget | None: ...
    ...
    def load_string(self, string: str, **kwargs: object) -> Widget | None: ...
    ...
    def match(self, widget) -> list[Any]:
        """Return a list of :class:`ParserRule` objects matching the widget."""
        ...

    def match_rule_name(self, rule_name) -> list[Any]:
        """Return a list of :class:`ParserRule` objects matching the widget."""
        ...
...
if "KIVY_PROFILE_LANG" in environ:
    def match_rule(fn, index, rule) -> Generator[Any, Any, None]: ...
