...
from kivy.event import EventDispatcher, ObjectWithUid
...
class Animation(EventDispatcher):
    ...
    def start(self, widget: ObjectWithUid) -> None: ...
    def stop(self, widget: ObjectWithUid) -> None: ...
    def cancel(self, widget: ObjectWithUid) -> None: ...
