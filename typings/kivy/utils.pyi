...
def intersection(set1, set2) -> list[Any]:
    """Return the intersection of 2 lists."""
    ...

def difference(set1, set2) -> list[Any]:
...
def rgba(s, *args) -> list[float] | list[Any]:
...
def deprecated(func=..., msg=...) -> partial[Any] | _Wrapped:
...
@deprecated
def interpolate(value_from, value_to, step=...) -> list[Any]:
...
class SafeList(list):
    ...
    def clear(self) -> None: ...
    @deprecated
    def iterate(self, reverse=...) -> Iterator[Any]: ...
...
class reify:
    ...
    def __get__(self, inst, cls) -> Self: ...
