...
class LabelBase:
    ...
    @staticmethod
    def register(
        name, fn_regular, fn_italic=..., fn_bold=..., fn_bolditalic=...
    ) -> None:
    ...
    @staticmethod
    def get_system_fonts_dir() -> list[Any]:
    ...
    def get_cached_extents(self) -> Callable[..., tuple[Literal[0], Literal[0]]]:
    ...
    def render(
        self, real=...
    ) -> tuple[Literal[0], Literal[0]] | tuple[int, int] | None:
    ...
    @property
    def size(self) -> tuple[Any | int, Any | int]: ...
    @property
    def width(self) -> int: ...
    @property
    def height(self) -> int: ...
    ...
    def content_size(
        self,
    ) -> tuple[Literal[0], Literal[0]] | tuple[Any | Literal[0], Any | Literal[0]]:
