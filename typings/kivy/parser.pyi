...
def color_error(text: str) -> tuple[int, int, int, int]: ...
def parse_color(text: str) -> list[float] | tuple[int, int, int, int]: ...
...
def parse_float4(text) -> list[float]:
