...
class DirectiveToc(Directive):
    ...
    def parse(
        self, block, m, state
    ) -> dict[str, str] | dict[str, str | tuple[Any, int | Any | None] | None]: ...
    def reset_toc_state(self, md, s, state) -> tuple[Any, Any]: ...
    def register_plugin(self, md) -> None: ...
    def __call__(self, md) -> None: ...

def record_toc_heading(
    text, level, state
) -> dict[str, str | Any | tuple[Any, str]]: ...
def md_toc_hook(md, tokens, state): ...
def render_ast_toc(items, title, depth) -> dict[str, str | list[list[Any]] | Any]: ...
def render_ast_theading(children, level, tid) -> dict[str, str | Any]: ...
def render_html_toc(items, title, depth) -> str: ...
def render_html_theading(text, level, tid): ...
def extract_toc_items(md, s) -> list[Any] | list[tuple[Any, LiteralString, Any]]:
